...
import static ru.oig.etyvpn.core.OpenVPNService.EXTRA_DO_NOT_REPLACE_RUNNING_VPN;
...
public class VpnProfile implements Serializable, Cloneable {
    ...
    public static final String EXTRA_PROFILEUUID = "ru.oig.etyvpn.profileUUID";
    public static final String EXTRA_PROFILE_VERSION = "ru.oig.etyvpn.profileVersion";
    ...
    private static final String EXTRA_RSA_PADDING_TYPE = "ru.oig.etyvpn.api.RSA_PADDING_TYPE";
    private static final String EXTRA_SALTLEN = "ru.oig.etyvpn.api.SALTLEN";
    private static final String EXTRA_NEEDS_DIGEST = "ru.oig.etyvpn.api.NEEDS_DIGEST";
    private static final String EXTRA_DIGEST = "ru.oig.etyvpn.api.DIGEST";
    ...
    public String getPlatformVersionEnvString() {
        return String.format(Locale.US, "%d %s %s %s %s %s", Build.VERSION.SDK_INT, Build.VERSION.RELEASE,
                "", Build.BRAND, Build.BOARD, Build.MODEL);
    }
