...
public class LaunchVPN extends Activity {
    ...
    public static final String EXTRA_KEY = "ru.oig.etyvpn.shortcutProfileUUID";
    public static final String EXTRA_NAME = "ru.oig.etyvpn.shortcutProfileName";
    public static final String EXTRA_HIDELOG = "ru.oig.etyvpn.showNoLogWindow";
