...
public class ExtAuthHelper {
    ...
    public static final String ACTION_CERT_CONFIGURATION = "ru.oig.etyvpn.api.ExternalCertificateConfiguration";
    public static final String ACTION_CERT_PROVIDER = "ru.oig.etyvpn.api.ExternalCertificateProvider";

    public static final String EXTRA_ALIAS = "ru.oig.etyvpn.api.KEY_ALIAS";
    public static final String EXTRA_DESCRIPTION = "ru.oig.etyvpn.api.KEY_DESCRIPTION";
