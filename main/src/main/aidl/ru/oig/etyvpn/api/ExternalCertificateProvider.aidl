...
interface ExternalCertificateProvider {
     ...
     *
     * EXTRA_ALIAS = "ru.oig.etyvpn.api.KEY_ALIAS"
     * EXTRA_DESCRIPTION = "ru.oig.etyvpn.api.KEY_DESCRIPTION"
     *
     ...
     * <ul>
       * <li>int key "ru.oig.etyvpn.api.RSA_PADDING_TYPE", may be set as:
       * <ul>
         * <li>0 - for RSA/ECB/nopadding
         * <li>1 - for RSA/ECB/PKCS1PADDING
         * <li>2 - for PKCS1PSSPADDING
       * </ul>
       * <li>string key "ru.oig.etyvpn.api.SALTLEN", may be set as:
       * <ul>
       ...
       * </ul>
       * <li>boolean key "ru.oig.etyvpn.api.NEEDS_DIGEST", indicating that the data should be
         * hashed before signing or not
       * <li>string key "ru.oig.etyvpn.api.DIGEST", the short common digest algorithm name to
